...
function yoursite_contact_page_customizer($wp_customize) {
    ...
    $wp_customize->add_setting('contact_hero_bg_start', array(
        'default' => '#ecfdf5', // green-50
        'sanitize_callback' => 'sanitize_hex_color',
        'transport' => 'refresh',
    ));
    
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'contact_hero_bg_start', array(
    ...
    $wp_customize->add_setting('contact_hero_bg_end', array(
        'default' => '#dbeafe', // blue-100
        'sanitize_callback' => 'sanitize_hex_color',
        'transport' => 'refresh',
    ));
    
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'contact_hero_bg_end', array(
    ...
    $wp_customize->add_control('contact_separator_1', array(
        ...
        'type' => 'text',
        'priority' => 20,
        'description' => __('Configure the contact options/methods section', 'yoursite'),
    ...
    $contact_defaults = array(
        ...
        2 => array(
            ...
            'button_text' => __('support@yoursite.biz', 'yoursite'),
        ...
        3 => array(
            ...
            'button_text' => __('+1 (555) 123-4567', 'yoursite'),
    ...
    $wp_customize->add_control('contact_form_title', array(
        'label' => __('Form Section Title', 'yoursite'),
        'section' => 'contact_page_editor',
        'type' => 'text',
        'priority' => 52,
        'active_callback' => function() {
    ...
    $wp_customize->add_control('contact_form_subtitle', array(
        'label' => __('Form Section Subtitle', 'yoursite'),
        'section' => 'contact_page_editor',
        'type' => 'text',
        'priority' => 53,
        'active_callback' => function() {
    ...
    $wp_customize->add_control('contact_office_address', array(
        ...
        'type' => 'textarea',
        'priority' => 75,
        'description' => __('Use &lt;br&gt; for line breaks', 'yoursite'),
        'active_callback' => function() {
            return get_theme_mod('contact_office_enable', true);
        },
    ));
    ...
    $wp_customize->add_control('contact_office_email', array(
        'label' => __('General Email', 'yoursite'),
        'section' => 'contact_page_editor',
        'type' => 'email',
        'priority' => 77,
        'active_callback' => function() {
