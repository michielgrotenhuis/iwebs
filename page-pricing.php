                ...
                <div class="max-w-7xl mx-auto">
                    ...
                    if (!empty($plans)) : ?>
                        ...
                        <div class="pricing-carousel-wrapper relative" style="padding: 40px 60px;">
                            <!-- Navigation Arrows -->
                            <button class="pricing-nav-btn pricing-nav-prev" style="margin-left: -20px;">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                                </svg>
                            </button>
                            <button class="pricing-nav-btn pricing-nav-next" style="margin-right: -20px;">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <?php else : ?>
                        <div class="text-center py-12">
                            <p class="text-white text-lg mb-4">No pricing plans available yet.</p>
